						...
						<div class="single-footer-widget">
							...
							<ul class="hr-list">
								<li class="d-flex justify-content-between">
									<span>Ponedeljak - Petak</span> <span>11:00 - 23:00 </span>
								</li>
								<li class="d-flex justify-content-between">
									<span>Subota</span> <span>14:00 - 00:00 </span>
								</li>
								<li class="d-flex justify-content-between">
									<span>Nedelja</span> <span>16:00 - 22:00</span>
								</li>
							</ul>
						</div>
					</div>
					<div class="col-lg-4  col-md-6 col-sm-6">
						<div class="single-footer-widget">
							...
							<ul class="hr-list"> 
								<li class="d-flex justify-content-between"> 
									<span>
									Zmaj Jove Jovanovića 2, Pančevo
									</span>
								</li>
								<li class="d-flex justify-content-between">
	...
	<script async="async" src="https://www.donesi.com/pancevo/lat/embed/?objectID=2285" type="text/javascript"></script>
	<!-- End Links -->
	</body>
