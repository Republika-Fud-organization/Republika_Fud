		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-6 home-about-left">
					...
					<a title='Redrekcija na stranicu O nama' href="about" class="primary-btn">Pročitajte više</a>
				</div>
			...
			<div class="row d-flex justify-content-center">
				<div class="menu-content pb-70 col-lg-8">
					<div class="title text-center">
						...
						<p> <a title='Redirekcija na stranicu Online naručivanje' href='menu'> Online naručivanje  </a>direktno sa našeg sajta </p>
					</div>
				</div>
			</div>
			...
			<div class="row d-flex justify-content-center">
				<div class="menu-content pb-70 col-lg-8">
					<div class="title text-center">
						...
						<p>Pogledajte sve fotografije u našoj <a href='gallery'> galeriji </a> !</p>
					</div>
				</div>
			</div>
