...
poslužena na takav način da osetite najbolje od svakog ukusa.
							...
							<a title='Online poručivanje' href="menu" class="primary-btn">Naš meni</a>
						</div>
					...
					<div class="row">
						<div class="col-lg-4">
							<div class="single-service">
								...
								<a title='Online poručivanje' href="menu">
									<h4>Sočni burgeri</h4>
								</a>
								<p>
						...
						<div class="col-lg-4">
							<div class="single-service">
								...
								<a title="Pivara Publika" href="#">
									<h4>Kraft piva iz puba <i> Publika </i></h4>  
								</a>	
								<p>
									U saradnji sa pubom <i> Publika </i> uz odličan izbor hrane možete uživati i u velikom izboru kraft piva.
								</p>
							</div>
						</div>												
					</div>
